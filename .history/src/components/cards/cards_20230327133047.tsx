...
import { collection, addDoc, updateDoc, getDoc, doc, DocumentReference, getFirestore, setDoc } from "firebase/firestore";
      ...
      const handleSubmit = async (event: { preventDefault: () => void }) => {
        ...
        try {
          ...
          try {
            ...
            try {
                await updateDoc(db.collection('Post').doc(postId), updatedPost);
