...
const Cards = ({ className }: CardsProps) => {
    ...
    const handleSubmit = async (event: { preventDefault: () => void }) => {
        ...
        const postRef = doc(db, "Post", post) as DocumentReference<PetPost>;
 // Replace "Post" with the name of your collection and "Post" with the ID of the post to be edited
