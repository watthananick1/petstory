  ...
  const handleTypeClick = (title: string) => {
    ...
    if (newInterestedTypes[title]) {
      ...
      setTypePets((prevTypePets) => ({
        ...prevTypePets,
        if (prevTypePets && prevTypePets.typePets) {
        typePets: prevTypePets.typePets.filter((typePet) => typePet !== title),
      }));
    } else {
      newInterestedTypes[title] = true;
      setTypePets((prevTypePets) => ({
        ...prevTypePets,
        typePets: [...prevTypePets.typePets, title],
      }));
      console.log(newInterestedTypes);
    }
    setInterestedTypes(newInterestedTypes);
    ...
    // userRef.update({ typePets: newInterestedTypes }, (error) => {
    //   if (error) {
